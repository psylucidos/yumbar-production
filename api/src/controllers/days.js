...
module.exports = {
  ...
  getDay: (date) => new Promise(function(resolve, reject) {
  ...
  getFlavourEntrys: (date, productionType) => new Promise(function(resolve, reject) {
    if (productionType === 'Cutting Day') {
  ...
  deleteFlavorEntry: (id) => new Promise(function(resolve, reject) {
    if (productionType === 'Cutting Day') {
      db.query(
  ...
  updateStaffEntry: (id, staffEntryData) => new Promise(function(resolve, reject) {
    db.query(
  ...
  deleteStaffEntry: (id) => new Promise(function(resolve, reject) {
    db.query(
  ...
  getStaffEntries: (date) => new Promise(function(resolve, reject) {
